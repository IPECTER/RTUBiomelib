...
public class NMS_1_21_R1 implements NMSInterface {
    ...
    public List<String> getBiomeTag(String tag) {
        Optional<HolderSet.Named<Biome>> holders = registry.getTag(TagKey.create(resourceKey, ResourceLocation.bySeparator(tag, ':')));
